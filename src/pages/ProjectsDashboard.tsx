...
export function ProjectsDashboard() {
   ...
   const filteredProjects = projects
    .filter((project): project is ProjectSummaryResponse => Boolean(project && project.name))
    .filter((project) =>
                        ...
                        <DropdownMenuTrigger asChild>
                            <Button variant="ghost" size="icon" className="h-9 w-9 rounded-full">
                                <Avatar className="h-9 w-9">
                                    <AvatarFallback className="bg-orange-500/20 text-white border border-orange-500/30 font-semibold">
                                        {(() => {
